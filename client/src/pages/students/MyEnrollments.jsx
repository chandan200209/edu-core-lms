...
const MyEnrollments = () => {
  const { enrolledCourses, calculateCourseDuration, navigate, getToken, userData, fetchUserEnrolledCourses, backendUrl, calculateNoOfLectures } = useContext(AppContext);
